...
def main():
    ...
    if page == "Главная страница":
        ...
        st.title("📊 Анализ зарплат за 2000-2023 гг. по видам деятельности")
        ...
        st.title("📉 Динамика номинальной и реальной зарплат (2000-2023 гг.)")
        ...
        st.title("📝 Динамика индексов номинальной и реальной зарплат (2001-2023 гг.)")
        ...
        st.title("📈 Прогнозирование зарплат на 2024-2028 годы")
        st.markdown("""
