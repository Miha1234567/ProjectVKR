...
def main():
    ...
    page = st.sidebar.selectbox(
        ...
        ["Главная страница",
         ...
         "Динамика номинальной и риальной з/п по отраслям",
         "Динамика индексов з\п по отрпслям",
    ...
    elif page == "Динамика номинальной и риальной з/п по отраслям":
    ...
    elif page == "Динамика индексов з\п по отрпслям":
